!(function ($) {
  ...
  slideCarousel.find(".carousel-inner").children(".carousel-item").each(function (index) {
    (index === 0) ?
      slideCarouselIndicators.append("<li data-target='#slideCarousel' data-slide-to='" + index + "' class='active'></li>") :
      slideCarouselIndicators.append("<li data-target='#slideCarousel' data-slide-to='" + index + "'></li>");
  });
